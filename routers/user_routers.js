...
router.post("/usedGiftandPromotion_code",userControllers.usedGiftandPromotion_code);
router.post("/favouriteShopList_filter",userControllers.favouriteShopList_filter);
router.post("/addReportOf_shop",userControllers.addReportOf_shop);
router.post("/inntoutProductFilter",userControllers.inntoutProductFilter);
